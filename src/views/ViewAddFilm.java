...
public class ViewAddFilm {
    ...
    public void addNewFilm(ArrayList<Realisateur> listReal) {
        ...
        txtAnnee.setWrapText(true);
            TextField anneeFilm = new TextField();
      ...
      Label ChoixReal = new Label("REALISATEUR:");
        ...
        ChoiceBox boxRealisateur = new ChoiceBox(list);
        ...
        txtImage.setWrapText(true);
           ...
           btn.setOnAction(event -> {
               ...
               if (anneeFilm.getText()!= null) {
                   int valeurAF = Integer.parseInt(anneeFilm.getText());
               }
