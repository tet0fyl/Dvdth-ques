...
public class Config {
    public static String urlFilmImg = "ressources/upload/imgFilm/";
    public static String urlImgFullLogo = "ressources/logo/DVD-STORE-FULL.png";
    public static String urlImgCDLogo = "ressources/logo/CD.png";
